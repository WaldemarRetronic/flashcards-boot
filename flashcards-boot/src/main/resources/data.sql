...
INSERT INTO USERS(ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, EMAIL, VERIFIED, LOCKED, ACC_CRED_EXPIRED) VALUES(1, 'Adam', 'Smith', 'smith', 'password', 'smith@example.com', TRUE, FALSE, FALSE);
INSERT INTO USERS(ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, EMAIL, VERIFIED, LOCKED, ACC_CRED_EXPIRED) VALUES(2, 'John', 'Kelly', 'kelly', 'password', 'kelly@example.com', FALSE, FALSE, FALSE);

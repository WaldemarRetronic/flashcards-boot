...
INSERT INTO USERS(USERNAME, PASSWORD, EMAIL, VERIFIED, LOCKED, ACC_CRED_EXPIRED) VALUES('smith', 'password', 'smith@example.com', TRUE, FALSE, FALSE);
INSERT INTO USERS(USERNAME, PASSWORD, EMAIL, VERIFIED, LOCKED, ACC_CRED_EXPIRED) VALUES('kelly', 'password', 'kelly@example.com', FALSE, FALSE, FALSE);
